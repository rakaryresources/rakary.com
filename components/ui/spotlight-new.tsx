...
export const Spotlight = ({
  ...
  const gradientFirst = isDark
    ? "radial-gradient(68.54% 68.72% at 55.02% 31.46%, hsla(210, 100%, 85%, 0.08) 0, hsla(210, 100%, 55%, 0.02) 50%, hsla(210, 100%, 45%, 0) 80%)"
    : "radial-gradient(68.54% 68.72% at 55.02% 31.46%, rgba(0, 0, 0, 0.15) 0, rgba(0, 0, 0, 0.05) 50%, rgba(0, 0, 0, 0) 80%)";

  const gradientSecond = isDark
    ? "radial-gradient(50% 50% at 50% 50%, hsla(210, 100%, 85%, 0.06) 0, hsla(210, 100%, 55%, 0.02) 80%, transparent 100%)"
    : "radial-gradient(50% 50% at 50% 50%, rgba(0, 0, 0, 0.1) 0, rgba(0, 0, 0, 0.03) 80%, transparent 100%)";

  const gradientThird = isDark
    ? "radial-gradient(50% 50% at 50% 50%, hsla(210, 100%, 85%, 0.04) 0, hsla(210, 100%, 45%, 0.02) 80%, transparent 100%)"
    : "radial-gradient(50% 50% at 50% 50%, rgba(0, 0, 0, 0.08) 0, rgba(0, 0, 0, 0.02) 80%, transparent 100%)";
